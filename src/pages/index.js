...
const Stats = styled(Col)`
  ...
  background: linear-gradient( 170deg, ${colors.black} 8%, ${colors.blue900} 100% );
  ...
  return (
    <Layout>
      ...
      <Other around="md" top="md"  className="background">
        <Stats md={6}>
          <Row>
            <Col md={3}><Num>2.5 yrs</Num><h6>in business</h6></Col>
            <Col md={2}><Num>7</Num><h6>clients</h6></Col>
            <Col md={3}><Num>28+</Num><h6>projects</h6></Col>
            <Col md={4}><Num>11 yrs</Num><h6>industry experience</h6></Col>
          </Row>
        </Stats>
      </Other>
