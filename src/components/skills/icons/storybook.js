  ...
  >
    <defs>
      <path
        ...
        id="storybookjs_svg__a"
      />
    </defs>
    <mask id="storybookjs_svg__b" fill="#fff">
      <use xlinkHref="#storybookjs_svg__a" />
    </mask>
    <use fill="#FF4785" xlinkHref="#storybookjs_svg__a" />
    <path
