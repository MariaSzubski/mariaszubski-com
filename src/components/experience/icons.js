...
const DateIcon = props => (
  <svg viewBox="0 0 18 18" width="1em" height="1em" {...props}>
    <path fill="#E6D29C" d="M2 3h14v2.5H2z" />
    <path fill="#FEC52E" d="M15.5 3.5v11h-13v-11h13m1-1h-15v13h15v-13z" />
    <path fill="#FEC52E" d="M6.5 7.5h1v1h-1z" />
    <path fill="#FEC52E" d="M5 .5h1v2H5zM12 .5h1v2h-1z" />
    <path
      fill="#E6D29C"
...
const WorkshopIcon = props => (
  <svg viewBox="0 0 18 18" width="1em" height="1em" {...props}>
    <path fill="#E6D29C" d="M2 3h1v8.999H2zM15 3h1v8.999h-1z" />
    <path
      fill="#FEC52E"
